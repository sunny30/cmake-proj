...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/sharadsingh/Dev/cpp_proj/build/Arrow-prefix/src/Arrow-build/src/xsimd_ep-stamp/xsimd_ep-configure-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "xsimd_ep configure command succeeded.  See also /Users/sharadsingh/Dev/cpp_proj/build/Arrow-prefix/src/Arrow-build/src/xsimd_ep-stamp/xsimd_ep-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
