...
#define ARROW_CXX_COMPILER_FLAGS " -fno-aligned-new -D_LIBCPP_DISABLE_AVAILABILITY  -Qunused-arguments -fcolor-diagnostics  -Wall -Wno-unknown-warning-option -Wno-pass-failed -msse4.2 "
