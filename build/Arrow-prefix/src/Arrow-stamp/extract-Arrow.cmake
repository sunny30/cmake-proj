...
#
get_filename_component(filename "/Users/sharadsingh/Dev/cpp_proj/build/Arrow-prefix/src/apache-arrow-21.0.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/sharadsingh/Dev/cpp_proj/build/Arrow-prefix/src/Arrow" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-Arrow${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-Arrow${i}")
